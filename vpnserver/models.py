...
class ConfigSettings (models.Model):
    ...
    ldap_base_dn = models.CharField("Основное имя домена", max_length=255, default="dc=example,dc=com")
...
class ConfigVpn (models.Model):
    ...
    Data for Rutoken Vpn server settings
    """    
    server_name = models.CharField('Внешний "белый" IP адрес сервера', max_length=15) # 255 - максимально возможная длина доменного имени
